        ...
        <div className='privacy__container'>
            ...
            <div className='privacy__content'>
                <div className='privacy__card'>
                    ...
                    <p>
                        Verantwortlich im Sinne der DSGVO ist die Technische Universität München (TUM), vertreten durch den Präsidenten. Bei
                        datenschutzrechtlichen Fragen wenden Sie sich bitte an:
                        <strong> beauftragter(at)datenschutz.tum.de</strong>
                    </p>
                    <hr className='privacy__lang-divider' />
                    <p>
                        The data controller within the meaning of the GDPR is the Technical University of Munich (TUM), represented by its
                        President. For data protection enquiries please contact:
                        <strong> beauftragter(at)datenschutz.tum.de</strong>
                    </p>
                </div>
                ...
                <div className='privacy__card'>
                    ...
                    <ul className='privacy__list'>
                        ...
                        <li>
                            <strong>Sitzungsdaten:</strong> Workspace-Kennung, IDE-Typ, Zeitstempel der letzten Aktivität; gespeichert in
                            Kubernetes-Custom-Resources für das automatische Sitzungs-Timeout.
                        </li>
                        <li>
                            <strong>Git-Daten:</strong> Git-Benutzername, Git-E-Mail, temporäres VCS-Zugriffstoken; nur im Arbeitsspeicher,
                            wird über die Data Bridge injiziert und nicht persistiert.
                        </li>
                        <li>
                            <strong>Server-Logs:</strong> IP-Adresse und Anfrage-Zeitstempel (Standard-HTTP-Logs) in der TUM-Infrastruktur.
                        </li>
                    </ul>
                    <hr className='privacy__lang-divider' />
                    <ul className='privacy__list'>
                        ...
                        <li>
                            <strong>Git data:</strong> Git username, Git email, temporary VCS access token; in-memory only, injected via the
                            Data Bridge and never persisted.
                        </li>
                        <li>
                            <strong>Server logs:</strong> IP address and request timestamps (standard HTTP logs) within TUM infrastructure.
                        </li>
                    </ul>
                </div>
                ...
                <div className='privacy__card'>
                    ...
                    <p>
                        Die Daten werden ausschließlich zur Bereitstellung der browserbasierten IDE-Lernumgebung für Lehrveranstaltungen der
                        TUM verarbeitet.
                    </p>
                    <hr className='privacy__lang-divider' />
                ...
                <div className='privacy__card'>
                    ...
                    <hr className='privacy__lang-divider' />
                    <p>
                        Processing is based on Art. 6(1)(e) GDPR in conjunction with Art. 4(1) BayDSG (public task of university teaching).
                ...
                <div className='privacy__card'>
                    ...
                    <p>
                        ...
                        <code>send-default-pii=false</code> ist aktiv; es werden keine personenbezogenen Daten übertragen. Daten verlassen
                        nicht die TUM-Infrastruktur.
                    </p>
                    <hr className='privacy__lang-divider' />
                    <p>
                        ...
                        <code>send-default-pii=false</code> is enabled; no personally identifiable information is transmitted. Data does not
                        leave TUM infrastructure.
                    </p>
                </div>
                ...
                <div className='privacy__card'>
                    ...
                    <ul className='privacy__list'>
                        ...
                        <li>
                            Werden unrichtige personenbezogene Daten verarbeitet, steht Ihnen ein Recht auf Berichtigung zu (Art. 16 DSGVO).
                        </li>
                        <li>
