        ...
        <div className='privacy__container'>
            ...
            <div className='privacy__content'>
                <div className='privacy__card'>
                    ...
                    <p>
                        The Technical University of Munich (TUM) is responsible for the processing of personal data in connection with the
                        TUM Theia Cloud service.
                    </p>
                </div>
                ...
                <div className='privacy__card'>
                    ...
                    <p>
                        We process personal data in accordance with the General Data Protection Regulation (GDPR) and the German Federal
                ...
                <div className='privacy__card'>
                    ...
                    <p>
                        Personal data is retained only as long as necessary for the purposes outlined above or as required by law. User data
                        is typically deleted after account termination or after a period of inactivity.
                    </p>
                </div>
